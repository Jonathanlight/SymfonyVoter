...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\UserRegisterType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\UserRegisterType']) ? $this->services['AppBundle\Form\UserRegisterType'] : $this->services['AppBundle\Form\UserRegisterType'] = new \AppBundle\Form\UserRegisterType()) && false ?: '_'};
